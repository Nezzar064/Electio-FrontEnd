<script context="module">
    ...
    export async function load({page}) {
        ...
        if (response) {
            return {props: {parties: response, decodedParams}};
        }
        return {
            message: response,
            error: new Error()
    ...
    <div class="grid flex-grow card rounded-box">
        ...
        <div class="p-10">
            <div class="form-control">
                ...
                <input placeholder="Firstname" bind:value={firstName} class="input max-w-xs"
                       type="text">
                <label class="label">
                    <span class="label-text text-base-100"><b>Last Name</b></span>
                </label>
                <input placeholder="Lastname" bind:value={lastName} class="input max-w-xs"
                       type="text">
